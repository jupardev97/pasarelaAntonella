...
class modeloPrenda {
    ...
    public function selectAll() {
        $sql = 'SELECT * FROM pas_pre WHERE est_pre = \'1\' ';
        $this->db->query($sql);
...
//End findOne($data);
    ...
    public function create($data) {
        ...
        if ($this->db->execute()) {
            if ($this->db->rowCount() > 0) {
                $result['reg'] = $this->db->rowCount();
                $result['msg'] = 'Prenda Agregada Correctamente';
                return $result;
            } else {
                $result['reg'] = 0;
...
//End udate($data)
    ...
    public function delete($data){
        ...
        $sql = 'UPDATE pas_pre SET est_pre = \'0\' WHERE ide_pre = :ide_pre';
