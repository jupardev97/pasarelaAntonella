...
class modeloInsumo {
    ...
    public function selectAll() {
        $sql = 'SELECT * FROM pas_ins WHERE est_ins = \'1\' ';
        $this->db->query($sql);
...
//End udate($data)
    ...
    public function delete($data){
        ...
        $sql = 'UPDATE pas_ins SET est_ins = \'0\' WHERE ide_ins = :ide_ins';
