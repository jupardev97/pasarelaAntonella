...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-03-2019 a las 22:07:23
...
CREATE TABLE `pas_tra` (
  ...
  `cla_tra` char(32) COLLATE utf8_spanish2_ci NOT NULL
...
('25982901', 1, 'Julian Paredes', 'Popita Carrera 4', NULL, NULL, 'ziffero');
